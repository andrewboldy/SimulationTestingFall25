...
//plotElectronMCParticlesMomHist(string filelist)
...
void plotElectronMCParticlesMomHist(const string &triggeredFilelist, const string &triggerableFilelist)
{
...
c1->SaveAs("eMinusMCParticlesAllTriggeredStartMomHist.pdf");
c1->Clear();
eMinusAllTriggerableStartMomHist->Draw();
c1->SaveAs("eMinusMCParticlesAllTriggerableStartMomHist.pdf");
c1->Clear();
eMinusAllTriggeredEndMomHist->Draw();
c1->SaveAs("eMinusMCParticlesAllTriggeredEndMomHist.pdf");
c1->Clear();
eMinusAllTriggerableEndMomHist->Draw();
c1->SaveAs("eMinusMCParticlesAllTriggerableEndMomHist.pdf");
c1->Clear();

cout << "Creating and saving 'rank 0' histograms." << endl;
eMinusRank0TriggeredStartMomHist->Draw();
c1->SaveAs("eMinusMCParticlesRank0TriggeredStartMomHist.pdf");
c1->Clear();
eMinusRank0TriggerableStartMomHist->Draw();
c1->SaveAs("eMinusMCParticlesRank0TriggerableStartMomHist.pdf");
c1->Clear();
eMinusRank0TriggeredEndMomHist->Draw();
c1->SaveAs("eMinusMCParticlesRank0TriggeredEndMomHist.pdf");
c1->Clear();
eMinusRank0TriggerableEndMomHist->Draw();
c1->SaveAs("eMinusMCParticlesRank0TriggerableEndMomHist.pdf");
c1->Clear();
...
legendA->Draw();
c1->SaveAs("eMinusMCParticlesAllTriggeredAndTriggerableStartMomHist.pdf");
c1->Clear();
...
legendB->Draw();
c1->SaveAs("eMinusMCParticlesAllTriggeredAndTriggerableEndMomHist.pdf");
c1->Clear();
...
legendC->Draw();
c1->SaveAs("eMinusMCParticlesRank0TriggeredAndTriggerableStartMomHist.pdf");
c1->Clear();
...
legendD->Draw();
c1->SaveAs("eMinusMCParticlesRank0TriggeredAndTriggerableEndMomHist.pdf");
c1->Clear();
...
legendE->Draw();
c1->SaveAs("eMinusMCParticlesTriggerableAllAndRank0StartMomHist.pdf");
c1->Clear();
...
legendF->Draw();
c1->SaveAs("eMinusMCParticlesTriggeredAllAndRank0StartMomHist.pdf");
c1->Clear();
...
legendG->Draw();
c1->SaveAs("eMinusMCParticlesTriggerableAllAndRank0EndMomHist.pdf");
c1->Clear();
...
legendH->Draw();
c1->SaveAs("eMinusMCParticlesTriggeredAllAndRank0EndMomHist.pdf");
c1->Clear();
...
legendI->Draw();
c1->SaveAs("eMinusMCParticlesFullParameterStartMomHist.pdf");
c1->Clear();
...
legendJ->Draw();
c1->SaveAs("eMinusMCParticlesFullParameterEndMomHist.pdf");
c1->Clear();
}
